...
public class ResourceServerConfig extends ResourceServerConfigurerAdapter {
	...
	public CorsConfigurationSource corsConfigurationSource() {
		...
		config.setAllowedOrigins(Arrays.asList("http://localhost:4200", "https://31.220.56.29", "https://dtodojalapa.xyz", "http://dtodojalapa.xyz", "http://dtodo.pangosoft.xyz",
				"http://dimsa.pangosoft.xyz"));
